    ...
    <?php while (have_posts()) : the_post(); ?>
        ...
        <div class="page-content">
            ...
            if (function_exists('get_field')) {
                $digital_marketing_content = get_field('digital_marketing_content');
                
                if ($digital_marketing_content) {
                    // Display a simple preview for backend users
                    echo '<div class="acf-preview">';
                    echo '<p><strong>ACF Data Available:</strong> This page has Digital Marketing fields configured.</p>';
