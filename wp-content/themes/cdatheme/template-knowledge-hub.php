    ...
    <?php while (have_posts()) : the_post(); ?>
        ...
        <div class="page-content">
            ...
            if (function_exists('get_field')) {
                $knowledge_hub_content = get_field('knowledge_hub_content');
                
                if ($knowledge_hub_content) {
                    // Display a simple preview for backend users
                    echo '<div class="acf-preview">';
                    echo '<p><strong>ACF Data Available:</strong> This page has Knowledge Hub fields configured.</p>';
