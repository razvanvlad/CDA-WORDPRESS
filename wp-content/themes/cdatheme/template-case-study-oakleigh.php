<?php
/*
Template Name: Case Study Oakleigh Page
*/
...
<div class="case-study-oakleigh-page">
    <?php while (have_posts()) : the_post(); ?>
        ...
        <div class="page-content">
            ...
            if (function_exists('get_field')) {
                $case_study_content = get_field('case_study_oakleigh_content');
                
                if ($case_study_content) {
                    // Display a simple preview for backend users
                    echo '<div class="acf-preview">';
                    echo '<p><strong>ACF Data Available:</strong> This page has Case Study Oakleigh fields configured.</p>';
